...
namespace Boss {
    ...
    public class CapeloboBoss : MonoBehaviour {
        ...
        public enum BossState { Idle, Chasing, Attacking, Taunting, Stunned, Defeated }
        ...
        [SerializeField] private int attacksBeforeTaunt = 3;
        ...
        [SerializeField] private Vector3 punchHitboxSize = new Vector3(1, 1, 1);
        [Tooltip("The radius of the spin attack check.")]
        [SerializeField] private float spinAttackRadius = 3f;
        ...
        [Tooltip("Particle effect prefab to spawn when the spin attack hits the player.")]
        [SerializeField] private GameObject spinImpactVFX;
        ...
        private IEnumerator AttackRoutine() {
            ...
            // Wait for the attack animation to finish (adjust time as needed).
            // A better way is to use Animation Events to call a damage-dealing function.
            yield return null;
